...
const Modal = ({ isOpen, onClose, title, children, width = "28rem", height = "34.5rem", className = "", titleColor = "" }: ModalProps) => {
	...
	return (
		<div
			...
			<div
				...
				style={{ width, height }}>
				{title && <h2 className={`text-xxl font-bold text-center mt-4 text-${titleColor}`}>{title}</h2>}
