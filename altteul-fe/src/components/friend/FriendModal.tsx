...
const FriendModal = ({
  ...
  return (
    ...
    >
      <div
        className="bg-gray-06 bUserSearchProviderorder-2 border-primary-orange rounded-lg w-[90vw] max-w-md h-[90vh] max-h-[80vh] p-4 shadow-lg relative flex flex-col"
      ...
      >
                ...
                {searchResults.map(user => (
                  ...
                  >
                    <div className="flex items-center gap-2">
                      <img src={user.profileImg} alt="프로필" className="w-8 h-8 rounded-full" />
        ...
        {showNavigation && (
          <div className="mt-4 flex justify-around border-t border-orange-300 pt-3">
            ...
            >
              <img src="/src/assets/icon/Friend_list.svg" alt="친구목록" className="w-10 h-10" />
            </button>
            ...
            >
              <img src="/src/assets/icon/Chat_bubble.svg" alt="채팅목록" className="w-9 h-9" />
            </button>
            ...
            <button
              ...
              className="relative flex flex-col items-center px-4 py-2 hover:scale-110 rounded-lg"
            >
              <img src="/src/assets/icon/Notifications.svg" alt="알림목록" className="w-9 h-9" />
            </button>
          </div>
        )}
      </div>
