...
const SelectPage = () => {
  return (
    <div className="relative flex items-center justify-center min-h-screen bg-cover bg-center" style={{ backgroundImage: `url(${backgroundImage})` }}>
      ...
      {/* 로고 링크 */}
      <Link to="/" className="absolute top-8 left-8 transition-all duration-300 hover:shadow-[0_0_15px_var(--primary-orange)]">
      ...
      <div className="relative flex gap-x-[40vh] items-center">
        ...
        <div className="flex flex-col items-center">
          <Link to="/single-search" className="w-[150px] h-[150px] rounded-full transition-all duration-500 hover:shadow-[0_0_30px_var(--primary-orange)]">
        ...
        {/* 팀전 버튼 링크 */}
        <div className="flex flex-col items-center">
          <Link to="/team-composition" className="w-[150px] h-[150px] rounded-full transition-all duration-500 hover:shadow-[0_0_30px_var(--primary-orange)]">
